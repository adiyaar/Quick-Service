...
public class RechargePaymentMethod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getuser_id = session_management.getUserDetails().get(com.sharp_dev.quick_service.Constants.Config.KEY_ID);
    ...
    private void makeAddOrderRequest(String plan_id,String paymentStatus,String coins,String price,String getuser_id) {
        ...
        com.sharp_dev.quick_service.Constants.CustomVolleyJsonRequest jsonObjReq = new com.sharp_dev.quick_service.Constants.CustomVolleyJsonRequest(Request.Method.POST,
                com.sharp_dev.quick_service.Constants.Config.ADD_ORDER_URL, params, new Response.Listener<JSONObject>() {
            @Override

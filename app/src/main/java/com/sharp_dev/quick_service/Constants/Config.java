package com.sharp_dev.quick_service.Constants;
...
public class Config {
    ...
    public static String BASE_URL = "https://project.sharpdev.in/Quick_Service/api/";
    public static String IMAGE_URL = "https://project.sharpdev.in/Quick_Service/"; //

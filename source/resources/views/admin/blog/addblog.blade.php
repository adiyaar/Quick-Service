                ...
                <div class="card-body">
                  <h4 class="card-title">Add-Ons</h4><br>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('addnewblog')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                      <div class="form-group">
                    <label for="exampleFormControlSelect3">Services</label>
                    <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="service_list">
                    ...
                    -->
                     <a href="{{route('addblog')}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
